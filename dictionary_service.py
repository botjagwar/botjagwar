...
parser.add_argument(
    "-d", "--db-file", dest="STORAGE", required=False, default="default"
)
...
app.router.add_route(
    "GET", "/definition_words/{definition_id}", definition.get_definition_with_words
)
app.router.add_route(
    "PUT", "/definition/{definition_id}/edit", definition.edit_definition
)
# app.router.add_route('POST', '/definition/{language}/create', definition.create_definition)
app.router.add_route(
    "DELETE", "/definition/{definition_id}/delete", definition.delete_definition
)
...
app.router.add_route(
    "GET", "/translations/{origin}/{target}/{word}", translation.get_translation
)
app.router.add_route(
    "GET", "/translations/{origin}/{word}", translation.get_all_translations
)
