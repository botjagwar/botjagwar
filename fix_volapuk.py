...
from api.translation_v2.functions.definitions.language_model_based import translate_using_nllb
    ...
    def run(self):
        ...
        for page in pages:
            ...
            if part_of_speech == '...' or not german_definition:
                continue
            mg_translation = translate_using_nllb(part_of_speech, german_definition, 'de', 'mg')
            ...
            entry = Entry(
                ...
                additional_data={
                    'reference': ["Arie de Jong, Michael Everson: ''Wörterbuch der Weltsprache für Deutschsprechende: "
