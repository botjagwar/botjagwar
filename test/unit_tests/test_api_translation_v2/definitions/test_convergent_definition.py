...
class TestTranslateUsingConvergentDefinition(TestCase):
    ...
    def test_translate_using_convergent_definition_1(self, convergent_translations):
        ...
        result = translate_using_convergent_definition(part_of_speech='ana', definition_line='test definition',
    ...
    def test_translate_using_convergent_definition_2(self, convergent_translations):
        ...
        result = translate_using_convergent_definition(part_of_speech='mat', definition_line='test definition2',
                                                       source_language='fr', target_language='mg')
        convergent_translations.get_convergent_translation.assert_called_once()
    ...
    def test_translate_using_convergent_definition_3(self, mock_get_convergent_translation):
