...
from api.parsers.functions.adjective_forms.templates import (
...
from api.parsers.functions.noun_forms.templates import (
    parse_fi_form_of as parse_fi_noun_form_of,
)
from api.parsers.functions.noun_forms.templates import (
    parse_lt_noun_form,
...
definitions_parser = WiktionaryDefinitionParser(wiki_language='en')
...
templates_parser.add_parser(
    ...
    parse_one_parameter_template(
        AdjectiveForm, "de-inflected form of", number="", gender=""
    ),
)
templates_parser.add_parser(
    AdjectiveForm, "el-form-of-nounadj", parse_el_form_of(AdjectiveForm)
)
...
templates_parser.add_parser(
    ...
    "feminine plural of",
    parse_one_parameter_template(
        AdjectiveForm, "feminine plural of", gender="f", number="p"
    ),
)
templates_parser.add_parser(
    AdjectiveForm,
    ...
    parse_one_parameter_template(
        AdjectiveForm, "feminine singular of", gender="f", number="s"
    ),
)
templates_parser.add_parser(
    AdjectiveForm,
    "feminine of",
    parse_one_parameter_template(AdjectiveForm, "feminine of"),
)
templates_parser.add_parser(AdjectiveForm, "fi-form of", parse_fi_adjective_form_of)
templates_parser.add_parser(
    AdjectiveForm, "lv-inflection of", parse_lv_inflection_of(AdjectiveForm)
)
templates_parser.add_parser(
    AdjectiveForm,
    "inflected form of",
    parse_one_parameter_template(
        AdjectiveForm, "inflected form of", number="", gender=""
    ),
)
templates_parser.add_parser(
    AdjectiveForm, "inflection of", parse_inflection_of(AdjectiveForm)
)
...
templates_parser.add_parser(
    ...
    "masculine plural of",
    parse_one_parameter_template(
        AdjectiveForm, "masculine plural of", number="p", gender="m"
    ),
)
...
templates_parser.add_parser(
    AdjectiveForm,
    "plural of",
    parse_one_parameter_template(AdjectiveForm, "plural of", number="p"),
)
...
templates_parser.add_parser(
    NounForm,
    "feminine singular of",
    parse_one_parameter_template(NounForm, "feminine singular of", number="s"),
)
templates_parser.add_parser(
    NounForm,
    "feminine plural of",
    parse_one_parameter_template(NounForm, "feminine plural of", number="p"),
)
templates_parser.add_parser(
    NounForm, "feminine of", parse_one_parameter_template(NounForm, "feminine of")
)
...
templates_parser.add_parser(NounForm, "infl of", parse_inflection_of(NounForm))
...
templates_parser.add_parser(
    NounForm,
    "inflected form of",
    parse_one_parameter_template(NounForm, "inflected form of"),
)
templates_parser.add_parser(NounForm, "lt-form-noun", parse_lt_noun_form)
templates_parser.add_parser(
    NounForm, "lv-inflection of", parse_lv_inflection_of(NounForm)
)
templates_parser.add_parser(
    NounForm,
    "masculine plural of",
    parse_one_parameter_template(
        NounForm, "masculine plural of", number="p", gender="m"
    ),
)
...
templates_parser.add_parser(
    ...
    "plural definite of",
    parse_one_parameter_template(
        NounForm, "plural definite of", number="p", definiteness="definite"
    ),
)
templates_parser.add_parser(
    NounForm,
    ...
    parse_one_parameter_template(
        NounForm, "plural indefinite of", number="p", definiteness="indefinite"
    ),
)
templates_parser.add_parser(
    NounForm,
    "plural of",
    parse_one_parameter_template(NounForm, "plural of", number="p"),
)
templates_parser.add_parser(
    NounForm,
    "singular definite of",
    parse_one_parameter_template(
        NounForm, "singular definite of", number="s", definiteness="definite"
    ),
)
templates_parser.add_parser(
    NounForm,
    ...
    parse_one_parameter_template(
        NounForm, "singular indefinite of", number="s", definiteness="indefinite"
    ),
)
...
templates_parser.add_parser(
    VerbForm,
    "pt-verb-form-of",
    parse_one_parameter_template(VerbForm, "pt-verb-form-of", number="", gender=""),
)
...
templates_parser.add_parser(VerbForm, "infl of", parse_verb_form_inflection_of)
...
templates_parser.add_parser(
    VerbForm, "lv-inflection of", parse_lv_inflection_of(VerbForm)
)
templates_parser.add_parser(
    VerbForm,
...
templates_parser.add_parser(
    ...
    "past participle of",
    parse_one_parameter_template(
        VerbForm, "past participle of", number="s", tense="past", mood="part"
    ),
)

templates_parser.add_parser(
    Romanization, "romanization of", parse_romanization_template(2)
)
templates_parser.add_parser(
    Romanization, "ja-romanization of", parse_romanization_template(1)
)
templates_parser.add_parser(
    Romanization, "ryu-romanization of", parse_romanization_template(1)
)
templates_parser.add_parser(
    Romanization, "pinyin reading of", parse_romanization_template(1)
)
templates_parser.add_parser(Romanization, "egy-alt", parse_romanization_template(1))
templates_parser.add_parser(
    NonLemma, "alternative spelling of", parse_romanization_template(1)
)

definitions_parser.add_parser(NounForm, parameterized_parse_fr_definition(NounForm))
definitions_parser.add_parser(AdjectiveForm, parameterized_parse_fr_definition(AdjectiveForm))

definitions_parser.add_parser(VerbForm, parse_fr_definition)
